...
//                .collect(Collectors.toList());
    ...
    @Test
    @DisplayName("데이터 검증[fail]: 존재하지 cake id 로 단건 아이템 상세 조회 api 테스트 ")
    @Transactional
    public void findBySingleDetailFail() {
        ...
        // when && then
        assertThatThrownBy(() -> cakeSearchService.findBySingleDetail(noExistItem)).isInstanceOf(NoDataException.class);
    }
